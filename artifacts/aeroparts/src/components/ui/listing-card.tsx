...
export function ListingCard({ listing }: ListingCardProps) {
  ...
  return (
    <div className="relative h-full">
      ...
      {/* Watchlist heart — positioned outside <a> to prevent navigation */}
      <button
        ...
        style={{
          ...
          background: watched ? "rgba(239,68,68,0.9)" : "rgba(10,22,40,0.75)",
          border: watched ? "1.5px solid rgba(239,68,68,0.6)" : "1.5px solid rgba(255,255,255,0.15)",
          display: "flex", alignItems: "center", justifyContent: "center",
          cursor: "pointer", backdropFilter: "blur(4px)",
          transition: "all 0.18s ease",
        }}
        onMouseEnter={e => {
          (e.currentTarget as HTMLButtonElement).style.background = watched ? "rgba(239,68,68,1)" : "rgba(239,68,68,0.85)";
        }}
        onMouseLeave={e => {
          (e.currentTarget as HTMLButtonElement).style.background = watched ? "rgba(239,68,68,0.9)" : "rgba(10,22,40,0.75)";
        }}
      >
        <Heart
          size={14}
          color={watched ? "#fff" : "#fff"}
